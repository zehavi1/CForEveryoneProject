...
void SemanticAnalyzer::exitScope(shared_ptr<ParentNode> node) {
	if (!scopes.empty()) {
...
void SemanticAnalyzer::declareVariable(shared_ptr<ParentNode> node)
{
...
void SemanticAnalyzer::declareVariableInForeach(shared_ptr<ParentNode> node)
{
...
bool SemanticAnalyzer::compareTypesInForeach(shared_ptr<ParentNode> node, shared_ptr<TokenNode> typeVar)
{
...
void SemanticAnalyzer::defineVariable(Token& token)
{
...
void SemanticAnalyzer::analyzeFunction(shared_ptr<ParentNode> node)
{
